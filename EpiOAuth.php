...
class EpiOAuth
{
  ...
  public function httpRequest($method = null, $url = null, $params = null, $data = null)
  {
    ...
    switch($method)
    {
      ...
      case 'POST':
        if(empty($params['oauth_signature']))
          $params = $this->prepareParameters($method, $url, $params);
        return $this->httpPost($url, $params, $data);
        break;
      case 'PUT':
        if(empty($params['oauth_signature']))
          $params = $this->prepareParameters($method, $url, $params);
        return $this->httpPut($url, $params, $data);
        break;
    }
  }
  ...
  protected function httpPost($url, $params = null, $data = null)
  {
    $ch = curl_init($url);
    $this->addOAuthHeaders($ch, $url, $params['oauth']);
